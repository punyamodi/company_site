        ...
        {[
          {
            ...
            body: `We collect information you provide directly to us, such as when you create an account, contact us for support, or fill out a form on our website. This includes name, email address, company name, and any communications you send us.\n\nWhen you use Onyx Enterprise, we also collect usage data to operate and improve the service, including query logs (which remain within your tenanted environment), connector sync metadata, and platform usage analytics.`,
          },
          {
            title: "2. How We Use Your Information",
            body: `We use collected information to provide, maintain, and improve the Onyx platform; to process transactions and send related information; to respond to comments, questions, and requests; to send technical notices, updates, and security alerts; and to monitor and analyze trends and usage.`,
          },
          {
            title: "3. Data Isolation and Tenancy",
            body: `Onyx Enterprise is a multi-tenant platform with strict data isolation. Your organizational data — including documents ingested from connected sources, user queries, and agent configurations — is scoped to your tenant and is never accessible to other customers or used to train shared models.\n\nFor air-gapped and self-managed deployments, all data remains entirely within your infrastructure and is never transmitted to Onyx systems.`,
          },
          {
            title: "4. No Model Training on Your Data",
            body: `We do not use your organizational content, user queries, or any data ingested from your connected sources to train, fine-tune, or improve any AI model — whether operated by Onyx or a third-party LLM provider. Your data is used solely for retrieval in service of your users' queries within your tenanted environment.`,
          },
          {
          ...
          },
          {
            ...
            body: `When you use Onyx with a cloud-hosted LLM provider (e.g., OpenAI, Anthropic, Azure OpenAI), queries are sent to that provider in accordance with your configured API integration. We recommend reviewing the privacy policies of your chosen LLM provider. For air-gapped deployments, no data is sent to external LLM providers.`,
          },
          {
            title: "8. Your Rights",
            body: `Depending on your jurisdiction, you may have rights to access, correct, delete, or port your personal data. To exercise these rights, contact us at privacy@onyx.ai. We will respond to requests within 30 days.`,
          },
          {
            title: "9. Contact",
            body: `For privacy-related questions, contact our privacy team at privacy@onyx.ai. For enterprise security reviews and compliance inquiries, contact your dedicated customer success manager or reach us at security@onyx.ai.`,
          },
        ].map((section) => (
