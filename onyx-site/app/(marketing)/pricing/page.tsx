        ...
        <div className="container container--tight" style={{ position: "relative", textAlign: "center" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <p style={{ fontSize: 18, color: "var(--nb-ink-muted)", lineHeight: 1.7, marginBottom: 16 }}>
              Onyx is priced based on deployment scale, feature set, and organizational requirements. All plans are tailored — talk to our team to understand what fits your organization.
            </p>
          </motion.div>
        </div>
      </section>
