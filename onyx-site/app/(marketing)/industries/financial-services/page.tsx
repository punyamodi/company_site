        ...
        <div className="container" style={{ position: "relative" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <p style={{ fontSize: 18, color: "var(--nb-ink-muted)", maxWidth: 620, lineHeight: 1.7, marginBottom: 48 }}>
              Banks, asset managers, and financial institutions require AI systems that meet the bar set by regulators, risk committees, and compliance officers. Onyx delivers — with full auditability, tenant isolation, and deployment options that satisfy the strictest security requirements.
            </p>
        ...
        <div className="container">
          <div className="cards-3">
            {[
              ...
              { icon: Database, title: "Air-Gapped Deployment", desc: "For trading desks and sensitive operations, Onyx can be deployed completely air-gapped — no data ever reaches the public internet." },
