        ...
        <div className="container" style={{ position: "relative" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <p style={{ fontSize: 18, color: "var(--nb-ink-muted)", maxWidth: 620, lineHeight: 1.7, marginBottom: 48 }}>
              Government agencies and defense organizations operate in environments where air-gap deployment, classification-aware access control, and data sovereignty are non-negotiable. Onyx supports fully isolated deployments that never touch the public internet.
            </p>
      ...
      <section className="section section--surface">
        <div className="container">
          <div className="cards-3">
            {[
              { icon: Server, title: "Air-Gapped Deployment", desc: "Onyx runs entirely within your secure enclave. Via Ollama or vLLM, LLM inferencing stays on-premises with zero data egress." },
