        ...
        <div className="container" style={{ position: "relative" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <p style={{ fontSize: 18, color: "var(--nb-ink-muted)", maxWidth: 600, lineHeight: 1.7, marginBottom: 48 }}>
              HR teams are constantly fielding the same questions about policies, benefits, onboarding, and procedures. Onyx HR agents handle Tier-1 queries at scale, freeing your people team to focus on strategic work.
            </p>
