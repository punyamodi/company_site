        ...
        <div className="container" style={{ position: "relative" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <p style={{ fontSize: 18, color: "var(--nb-ink-muted)", maxWidth: 600, lineHeight: 1.7, marginBottom: 48 }}>
              Legal and compliance teams handle the most sensitive documents in the enterprise. Onyx delivers AI-powered contract search, policy retrieval, and regulatory analysis — with document-level access control that ensures only authorized users see sensitive materials.
            </p>
        ...
        <div className="container">
          <div className="cards-3">
            {[
              ...
              { icon: Lock, title: "Document-Level ACLs", desc: "Onyx mirrors your existing document permissions from SharePoint, Google Drive, or your DMS. Confidential contracts are never exposed to unauthorized users." },
