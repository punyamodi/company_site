...
const PILLARS = [
  ...
  { icon: Server, title: "Deployment Options", desc: "Kubernetes, Docker Compose, or air-gapped. Onyx runs in your cloud, your data center, or completely offline.", href: "/enterprise/deployment" },
        ...
        <div className="container" style={{ position: "relative" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <p style={{ fontSize: 18, color: "var(--nb-ink-muted)", maxWidth: 620, lineHeight: 1.7, marginBottom: 48 }}>
              Onyx Enterprise is purpose-built for regulated industries and complex organizations. Security, compliance, access control, and deployment flexibility are first-class concerns — not add-ons.
            </p>
      ...
      <section className="section section--invert">
        <div className="container container--tight" style={{ textAlign: "center" }}>
          <h2 style={{ fontSize: "clamp(28px,4vw,52px)", fontWeight: 800, letterSpacing: "-0.04em", color: "var(--nb-bg)", marginBottom: 20 }}>
            Ready to evaluate Onyx Enterprise?
          </h2>
