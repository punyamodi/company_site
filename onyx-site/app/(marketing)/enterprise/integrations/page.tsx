        ...
        <div className="container" style={{ position: "relative" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <h1 style={{ fontSize: "clamp(40px,5.5vw,76px)", fontWeight: 800, letterSpacing: "-0.045em", lineHeight: 0.95, maxWidth: 760, marginBottom: 20 }}>
              Connect Onyx to<br /><span style={{ fontFamily: "var(--font-fraunces, serif)", fontStyle: "italic", fontWeight: 300 }}>everything that matters.</span>
            </h1>
            <p style={{ fontSize: 18, color: "var(--nb-ink-muted)", maxWidth: 620, lineHeight: 1.7, marginBottom: 48 }}>
              Enterprise deployments require deep integration with existing IT infrastructure — identity providers, data sources, ticketing systems, and internal services. Onyx was designed for this.
            </p>
        ...
        <div className="container">
          <div className="cards-2">
            {[
              ...
              { icon: Webhook, title: "Webhook & Event API", desc: "Subscribe to Onyx events via webhooks for custom integrations — post-query callbacks, agent completions, and alert triggers for your internal systems.", features: ["Query events", "Agent completion hooks", "Connector sync status", "Admin event stream"] },
              { icon: Code2, title: "REST API", desc: "Every capability in Onyx is available via REST API. Build custom front-ends, embed Onyx into internal portals, or automate queries from scheduled jobs.", features: ["Full query API", "Connector management API", "User management API", "Admin configuration API"] },
            ].map((f, i) => {
              const Icon = f.icon;
              return (
