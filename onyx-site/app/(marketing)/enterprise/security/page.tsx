        ...
        <div className="container" style={{ position: "relative" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <p style={{ fontSize: 18, color: "var(--nb-ink-muted)", maxWidth: 620, lineHeight: 1.7, marginBottom: 48 }}>
              Security in Onyx is not a layer added on top — it is fundamental to the architecture. From identity integration to document-level permissioning to audit logging, every component was designed with enterprise security requirements as the primary constraint.
            </p>
        ...
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "start" }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                {[
                  { icon: Shield, title: "Document-Level Permissions", desc: "Onyx mirrors existing ACLs from your connected sources. A user who can't see a document in Confluence can't see it through Onyx." },
