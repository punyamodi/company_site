          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
              ...
              <p style={{ fontSize: 17, color: "var(--nb-ink-muted)", lineHeight: 1.7, marginBottom: 36 }}>
                Onyx implements the Model Context Protocol (MCP) natively — giving your agents the ability to interact with any external system, execute workflows, and take real-world actions beyond retrieval and generation.
              </p>
        ...
        <div className="container">
          ...
          <div className="cards-3">
            {[
              ...
              { icon: Server, title: "MCP Server", desc: "Onyx runs a built-in MCP server that registers tools from your own APIs, internal services, or third-party integrations." },
              { icon: Code2, title: "Custom Tool Development", desc: "Build new MCP tools using any programming language. Register them with Onyx and they become available to all agents immediately." },
