        ...
        <div className="container" style={{ position: "relative" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <p style={{ fontSize: 18, color: "var(--nb-ink-muted)", maxWidth: 600, lineHeight: 1.7, marginBottom: 48 }}>
              Onyx is a unified platform that connects, indexes, and activates your organization's institutional knowledge — with custom agents, deep research, and complete security controls.
            </p>
      ...
      <section className="section section--invert">
        <div className="container container--tight" style={{ textAlign: "center" }}>
          ...
          <p style={{ fontSize: 16, color: "rgba(250,249,246,0.65)", lineHeight: 1.75, marginBottom: 32 }}>
            OpenAI, Anthropic, Google Gemini, AWS Bedrock, Azure OpenAI, Mistral, and self-hosted models via Ollama or vLLM. Onyx is model-agnostic by design.
          </p>
