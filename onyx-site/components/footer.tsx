        ...
        <div className="ox-footer-main">
          ...
          <div>
            <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none", marginBottom: 20 }}>
              ...
              <span style={{ fontFamily: "var(--font-bricolage, sans-serif)", fontSize: 20, fontWeight: 800, color: "#FAF9F6", letterSpacing: "-0.05em" }}>Onyx</span>
            </Link>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              {[
                ...
                <a key={href} href={href} target="_blank" rel="noopener noreferrer"
                  ...
                  onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "var(--nb-amber)"; (e.currentTarget as HTMLElement).style.color = "var(--nb-amber)"; (e.currentTarget as HTMLElement).style.background = "rgba(245,158,11,0.08)"; }}
                  onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(255,255,255,0.2)"; (e.currentTarget as HTMLElement).style.color = "rgba(250,249,246,0.6)"; (e.currentTarget as HTMLElement).style.background = "transparent"; }}
                >
                  <Icon size={15} />
                </a>
              ))}
