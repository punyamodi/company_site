        ...
        <div className="container" style={{ position: "relative" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <p style={{ fontSize: 18, color: "var(--nb-ink-muted)", maxWidth: 620, lineHeight: 1.7, marginBottom: 48 }}>
              Genie runs wherever you need it. Cloud-hosted, self-managed on Kubernetes, containerized with Docker Compose, or fully air-gapped with no internet dependency. The same platform, the same capabilities, deployed to your security posture.
            </p>
            ...
            {[
              {
                icon: Cloud,
                title: "Cloud-Hosted",
                desc: "Genie manages infrastructure, scaling, and updates. Your data remains in an isolated tenant. Fastest time-to-deployment for teams prioritizing speed.",
              ...
              },
              {
                ...
                desc: "Deploy Genie on your Kubernetes cluster with Helm charts. Full control over your infrastructure, networking, and data residency.",
              ...
              },
              {
                icon: Wifi,
                title: "Air-Gapped",
                desc: "For organizations that require complete network isolation. Genie runs entirely on-premises with local LLM inference via Ollama or vLLM. Zero public internet dependency.",
      ...
      <section className="section">
        <div className="container container--narrow">
          ...
          <p style={{ fontSize: 16, color: "var(--nb-ink-muted)", lineHeight: 1.7, marginBottom: 32 }}>
            Genie is LLM-agnostic. Connect to the inference provider that fits your security posture, cost model, and performance requirements.
          </p>
