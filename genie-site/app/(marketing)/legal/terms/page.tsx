        ...
        {[
          {
            ...
            body: `By accessing or using Genie (the "Service"), you agree to be bound by these Terms of Service ("Terms"). If you are using the Service on behalf of an organization, you represent that you have the authority to bind that organization to these Terms.`,
          },
          {
            title: "2. Description of Service",
            body: `Genie is an enterprise AI platform that enables organizations to connect their knowledge sources, build AI agents, and provide intelligent search and research capabilities to their teams. The Service is offered as a cloud-hosted managed service or as a self-managed software platform deployed in your own infrastructure.`,
          },
          {
          ...
          {
            title: "4. Your Data",
            body: `You retain all rights to your organizational data, documents, and content ("Customer Data") that you provide to or access through the Service. You grant Genie a limited license to process Customer Data solely to provide the Service.\n\nGenie does not use Customer Data to train AI models. For the avoidance of doubt, documents synced from your connected sources, user queries, and agent outputs are Customer Data and are subject to the protections described in our Privacy Policy.`,
          },
          {
          ...
          },
          {
            ...
            body: `Service availability and support response time commitments are defined in the enterprise agreement applicable to your deployment. Standard cloud-hosted deployments are subject to Genie's published Service Level Agreement. Self-managed deployments are not covered by cloud-hosted SLA commitments.`,
          },
          {
            title: "7. Intellectual Property",
            body: `Genie and its licensors own all rights, title, and interest in and to the Service, including all intellectual property rights. These Terms do not grant you any right to use Genie's trademarks, logos, or brand identifiers.`,
          },
          {
            title: "8. Limitation of Liability",
            body: `To the maximum extent permitted by applicable law, Genie's total liability for claims arising from these Terms or the Service shall not exceed the amounts paid by you in the twelve months preceding the claim. Genie shall not be liable for any indirect, incidental, special, consequential, or punitive damages.`,
          },
          {
          ...
          {
            title: "10. Contact",
            body: `Questions about these Terms should be directed to legal@genie.ai.`,
          },
        ].map((section) => (
