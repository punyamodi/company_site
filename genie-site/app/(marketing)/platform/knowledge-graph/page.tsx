          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
              ...
              <p style={{ fontSize: 17, color: "var(--nb-ink-muted)", lineHeight: 1.7, marginBottom: 36 }}>
                Genie builds a knowledge graph across all your indexed documents — extracting entities, relationships, and concepts, then mapping how they connect across sources. Agents reason over the graph, not just individual documents.
              </p>
      ...
      <section className="section section--invert">
        <div className="container container--tight" style={{ textAlign: "center" }}>
          ...
          <p style={{ fontSize: 16, color: "rgba(250,249,246,0.65)", marginBottom: 32 }}>
            Schedule a demo and we'll show you the entity graph Genie builds from a sample of your connected sources.
          </p>
