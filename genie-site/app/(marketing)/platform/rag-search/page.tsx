          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
              ...
              <p style={{ fontSize: 17, color: "var(--nb-ink-muted)", lineHeight: 1.7, marginBottom: 36 }}>
                Genie combines dense vector embeddings with BM25 keyword search in a custom hybrid retrieval pipeline. The result: precise, context-aware answers that scale to tens of millions of documents without degrading in quality.
              </p>
      ...
      <section className="section section--surface">
        <div className="container">
          ...
          <h2 style={{ fontSize: "clamp(28px,3.5vw,46px)", fontWeight: 800, letterSpacing: "-0.04em", marginBottom: 48 }}>
            How Genie retrieval<br /><span style={{ fontFamily: "var(--font-fraunces, serif)", fontStyle: "italic", fontWeight: 300 }}>outperforms standard RAG.</span>
          </h2>
          <div className="cards-3">
            {[
              ...
              { icon: Network, title: "Knowledge Graph Layer", desc: "Beyond vector similarity — Genie builds entity-relationship graphs across your corpus so agents can reason about connected information, not just similar text.", accent: "var(--nb-teal)" },
      ...
      <section className="section section--invert">
        <div className="container container--tight" style={{ textAlign: "center" }}>
          ...
          <p style={{ fontSize: 16, color: "rgba(250,249,246,0.65)", marginBottom: 32 }}>
            We'll run a proof-of-concept connecting Genie to your most critical knowledge sources and demonstrate retrieval quality on your real data.
          </p>
