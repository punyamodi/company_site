        ...
        <div className="container" style={{ position: "relative" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <p style={{ fontSize: 18, color: "var(--nb-ink-muted)", maxWidth: 620, lineHeight: 1.7, marginBottom: 48 }}>
              Technology companies have the highest standards for the tools they adopt. Genie is built for engineering-first organizations: fully customizable agents, MCP for action integration, a complete API surface, and the flexibility to run any LLM stack you need.
            </p>
      ...
      <section className="section section--surface">
        <div className="container">
          <div className="cards-3">
            {[
              { icon: Code2, title: "API-First Architecture", desc: "Every capability in Genie is accessible via REST API. Build custom interfaces, integrations, and workflows that embed Genie into your product and processes." },
              ...
              { icon: Database, title: "Any LLM Stack", desc: "Genie works with every major LLM provider and also supports self-hosted models via Ollama and vLLM — giving your team full control over the inference layer." },
              { icon: Settings, title: "Deep Customization", desc: "Custom system prompts, retrieval tuning, persona configuration, and per-agent tool selection. Genie adapts to your product requirements, not vice versa." },
