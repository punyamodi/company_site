        ...
        <div className="container" style={{ position: "relative" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <p style={{ fontSize: 18, color: "var(--nb-ink-muted)", maxWidth: 600, lineHeight: 1.7, marginBottom: 48 }}>
              Sales teams burn time hunting for battlecards, product docs, and past deal context. Genie agents trained on your GTM materials answer prospect questions, draft proposals, and surface competitive intelligence in seconds.
            </p>
      ...
      <section className="section section--invert">
        <div className="container container--tight" style={{ textAlign: "center" }}>
          ...
          <p style={{ fontSize: 16, color: "rgba(250,249,246,0.65)", marginBottom: 32 }}>
            Genie agents are always available, always current, and never forget a battlecard.
          </p>
          <Link href="/contact" className="btn-primary" style={{ textDecoration: "none" }}>
