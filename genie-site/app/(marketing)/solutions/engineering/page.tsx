          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
              ...
              <p style={{ fontSize: 17, color: "var(--nb-ink-muted)", lineHeight: 1.7, marginBottom: 36 }}>
                Engineering teams waste hours every week searching across Jira, Confluence, GitHub, Slack, and runbooks for information that exists but is buried. Genie surfaces it in seconds — without context-switching.
              </p>
      ...
      <section className="section section--surface">
        <div className="container">
          <div className="cards-3">
            {[
              { icon: Search, title: "Codebase Q&A", desc: "Ask questions about your codebase in plain English. Genie searches GitHub, inline docs, and architecture Confluence pages simultaneously." },
