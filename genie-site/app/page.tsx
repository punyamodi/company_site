        ...
        <div className="ox-hero-grid" style={{ maxWidth: 1264, margin: "0 auto", width: "100%", position: "relative", display: "grid", gap: 64, alignItems: "center" }}>
          ...
          <div>
            ...
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2, ease: [0.16, 1, 0.3, 1] }}
              ...
              Genie connects to every tool your team uses, indexes it with best-in-class hybrid RAG, and puts custom AI agents to work — with full enterprise security and on-premises deployment.
            </motion.p>
        ...
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            <p style={{ fontSize: 17, color: "var(--nb-ink-muted)", maxWidth: 540, lineHeight: 1.7, marginBottom: 64 }}>
              From custom agents that know your codebase to deep research that synthesizes thousands of documents — Genie turns your fragmented knowledge into actionable intelligence.
            </p>
          </motion.div>
        ...
        <div className="container" style={{ position: "relative" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 2 }}>
            {[
              ...
              { step: "02", title: "Index", desc: "Genie runs hybrid search indexing — dense vector embeddings plus BM25 — building a knowledge graph that maps entity relationships across all your sources.", icon: Network },
          ...
          <div className="ox-split-2col" style={{ display: "grid", gap: 64, alignItems: "center" }}>
            <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.55 }}>
              ...
              <p style={{ fontSize: 16, color: "var(--nb-ink-muted)", lineHeight: 1.75, marginBottom: 28 }}>
                Genie natively connects to 40+ knowledge sources — from Slack and Confluence to Salesforce and GitHub — keeping your agents informed and up-to-date automatically.
              </p>
        ...
        <div className="container">
          <div className="ox-split-2col" style={{ display: "grid", gap: 64, alignItems: "center" }}>
            ...
            <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.55 }}>
              ...
              <p style={{ fontSize: 16, color: "var(--nb-ink-muted)", lineHeight: 1.75, marginBottom: 28 }}>
                Genie was built for organizations where data governance isn't optional. From document-level permissioning to fully air-gapped deployments, every security requirement is met out of the box.
              </p>
        ...
        <div className="container">
          ...
          <div className="cards-2">
            {[
              ...
              { title: "Legal & Compliance", desc: "Surface relevant contracts, policy documents, and regulation guidelines. Genie respects document-level ACLs so sensitive materials stay protected.", href: "/solutions/legal-compliance", icon: Shield, accent: "var(--nb-violet)" },
        ...
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            <p style={{ fontSize: 16, color: "var(--nb-ink-muted)", maxWidth: 540, lineHeight: 1.75, marginBottom: 48 }}>
              From Kubernetes clusters to fully air-gapped on-premises environments — Genie deploys wherever your data governance requirements demand.
            </p>
          </motion.div>
